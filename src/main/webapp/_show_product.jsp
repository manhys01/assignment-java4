...
<div class="container">
	<m:getRowsOfListProducts maxResult="8" />
								...
								<div class="card">
									<div class="card-header">
										<a href="#ProdcutDetail${p.id}" data-toggle="modal"
											...
											class="card-img-top product-image" src="${p.image}"
											alt="${p.name}">
										</a>
									</div>
									<div class="card-body">
																			...
																			<table class="table table-bordered">
																				...
																				<tr>
																					...
																					<td><fmt:formatNumber type="number"
																							maxFractionDigits="3" value="${p.price}" /> <sup>đ</sup>
																					</td>
																				</tr>
																				<tr>
																					<td>Trạng thái</td>
										...
										<c:choose>
											<c:when test="${!p.discontinued}">
												<p class="text-danger font-weight-normal text-right">
													<span class="badge badge-danger"> <fmt:formatNumber
															type="number" maxFractionDigits="3" value="${p.price}" />
														<sup>đ</sup>
													</span>
												</p>
												<c:choose>
											...
											<c:otherwise>
												<p class="text-danger font-weight-normal text-right">
													<span class="badge badge-secondary"> <small>Ngừng
															kinh doanh</small>
													</span>
												</p>
											</c:otherwise>
...
<div class="container">
	<hr>
	<m:paginate max="8" totalRecords="${totalRecords}" page="${param.page}"
